...
data_ip="https://raw.githubusercontent.com/abchede/izin/main/seler"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/abchede/izin/main/"
...
REPO="https://github.com/abchede/izin.git"
...
#edit link https://justpaste.it/edit/62611923/jvkpgifwvqum13le
    ...
    git remote add origin https://github.com/abchede/izin
    git push -f https://${TOKEN}@github.com/abchede/izin.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
