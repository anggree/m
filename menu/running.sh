...
Exp=$(curl -sS https://raw.githubusercontent.com/abchede/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
Exp2=$(curl -sS https://raw.githubusercontent.com/abchede/izin/main/ip | grep $MYIP | awk '{print $3}')
...
# DNS PATCH
#tipeos2=$(uname -m)
Name2=$(curl -sS https://raw.githubusercontent.com/abchede/izin/main/ip | grep $MYIP | awk '{print $2}')
# GETTING DOMAIN NAME
...
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1 $NC  ${WH}• SSH                     ${COLOR1}: ${WH}$status_ssh${NC}"
